...
FAMISTUDIO_EXP_NOTE_START = 7
    ...
    .if (FAMISTUDIO_USE_VRC6_SAW_FULL_VOLUME != 0) & (FAMISTUDIO_USE_VOLUME_TRACK = 0)
...
famistudio_volume_slide_frac: .rs FAMISTUDIO_NUM_VOLUME_SLIDES
    .endif
    .endif
    .endif
...
famistudio_vrc6_saw_full_volume:  .rs 1
    .endif
    .if FAMISTUDIO_USE_PHASE_RESET
...
famistudio_mmc5_pulse2_prev:      .rs 1
    ...
    .if FAMISTUDIO_EXP_FDS
famistudio_fds_master_volume:     .rs 1 ; Bit 7 = hold volume, bit 6 = full range volume.
...
; FAMISTUDIO_MUL is shared between FDS automod, FDS 32-step volume, and VRC6 saw 64-step volume.
    .if (((FAMISTUDIO_EXP_FDS != 0) & ((FAMISTUDIO_USE_FDS_AUTOMOD != 0) | (FAMISTUDIO_USE_VOLUME_TRACK != 0))) | ((FAMISTUDIO_EXP_VRC6 != 0) & (FAMISTUDIO_USE_VRC6_SAW_FULL_VOLUME != 0)))
